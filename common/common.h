...
struct common_params_sampling {
    ...
    std::string               reasoning_budget_intro_mode = "every"; // "once" = intro only for the first reasoning block of a conversation (deduped against the prompt), "every" = every block
