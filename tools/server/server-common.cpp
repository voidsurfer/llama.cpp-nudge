    ...
    // Reasoning budget: pass parameters through to sampling layer
    {
        ...
        if (!chat_params.thinking_end_tags.empty()) {
            ...
            const bool has_per_request_reasoning = reasoning_budget >= 0
                ...
                || body.contains("reasoning_budget_soft2_ratio")
                || body.contains("reasoning_budget_soft2_message")
                || body.contains("reasoning_budget_intro_message")
                || body.contains("reasoning_budget_intro_mode")
            ...
            if (has_per_request_reasoning) {
                ...
                llama_params["reasoning_budget_soft2_ratio"] = json_value(body, "reasoning_budget_soft2_ratio", opt.reasoning_budget_soft2_ratio);
                llama_params["reasoning_budget_soft2_message"] = json_value(body, "reasoning_budget_soft2_message", opt.reasoning_budget_soft2_message);
                ...
                llama_params["reasoning_budget_intro_mode"] = json_value(body, "reasoning_budget_intro_mode", opt.reasoning_budget_intro_mode);
